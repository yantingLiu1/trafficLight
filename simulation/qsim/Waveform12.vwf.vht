...
-- *****************************************************************************
-- Generated on "07/13/2025 13:50:25"
...
COMPONENT LogicalStep_Lab4_top
	PORT (
	blink_sig_out : BUFFER STD_LOGIC;
	clkin_50 : IN STD_LOGIC;
	es_seg_a : BUFFER STD_LOGIC;
	es_seg_d : BUFFER STD_LOGIC;
	es_seg_g : BUFFER STD_LOGIC;
	leds : BUFFER STD_LOGIC_VECTOR(7 DOWNTO 0);
	ns_seg_a : BUFFER STD_LOGIC;
	ns_seg_d : BUFFER STD_LOGIC;
	ns_seg_g : BUFFER STD_LOGIC;
	pb_n : IN STD_LOGIC_VECTOR(3 DOWNTO 0);
	rst_n : IN STD_LOGIC;
	seg7_char1 : BUFFER STD_LOGIC;
	seg7_char2 : BUFFER STD_LOGIC;
	seg7_data : BUFFER STD_LOGIC_VECTOR(6 DOWNTO 0);
	sm_clken_out : BUFFER STD_LOGIC;
